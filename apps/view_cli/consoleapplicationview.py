...
class ConsoleApplicationView:
    ...
    def print_category_selection(self, category_tuple):
        ...
        print("\nVeuillez sélectionner tout d'abord la catégorie d'aliment souhaitée:")
    ...
    def print_subsitute_products(self, substitute_product_tuple):
        ...
        print("\nVoici une liste de produits de subsitution qui pourrait vous plaire:")
    ...
    def print_action_choice(self):
        ...
        print("##############################")
        print("\nTrouvez votre aliment de substitution!")
        print("\nQue souhaitez-vous faire?")
        print("   1. Chercher un produit de substitution")
        print("   2. Consulter vos produits sauvegardé")
        print("\nVeuillez sélectionner le numéro correspondant à votre choix")
    ...
    def print_products_saved(self, product_tuple):
        ...
        for index, product in enumerate(product_tuple):
            ...
            print("    - Url : {}".format(product[3]))
            print("    - Nutriscore : {}".format(product[4]))
            print("    - Code-barre : {}".format(product[5]))
            print("    - Etat : {}\n".format(product[6]))
